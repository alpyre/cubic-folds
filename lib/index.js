...
module.exports = {
	...
	config: {
    "autoFoldAtStart": {
      "title": "Auto fold-all at start?",
      "type": "boolean",
			"default": true,
      "description": "When a document is opened all GoldEd/CubicIDE style foldable sections in it will be folded to begin with.",
      "order": 1
    }
  },
	...
	activate: function(state) {
		...
		//When a new editor is opened, attempt quietly to fold all GoldEd style fold sections.
		this.subscriptions.add(atom.workspace.observeTextEditors((editor) => {
				if (atom.config.get('cubic-folds.autoFoldAtStart'))
